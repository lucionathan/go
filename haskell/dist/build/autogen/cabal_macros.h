...
/* package haskell-go-0.1.1.0 */
#define VERSION_haskell_go "0.1.1.0"
#define MIN_VERSION_haskell_go(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "haskell-go-0.1.1.0"

#define CURRENT_PACKAGE_KEY "haskell-go-0.1.1.0"
